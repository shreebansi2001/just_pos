...
pageName: 'Crm Dashboard',
  ...
  // },
    ...
    moduleName: 'CrmLeads',
    children: [
      { title: 'All Leads',      icon: List,        path: '/leads/dashboard', pageName: 'Crm All Leads' },
      { title: 'Add Lead',       icon: CirclePlus,  path: '/leads/addlead',   pageName: 'Crm Add Lead' },
      { title: 'Lead Status',  icon: Tag,         path: '/leads/status',    pageName: 'Crm Lead Status' },
      { title: 'Lead Sources',   icon: Share2,      path: '/leads/source',    pageName: 'Crm Lead Sources' },
    ],
  },
 {
    title: 'Report',
  ...
  // },
   {
    ...
    icon: UserCog,
    pageName: 'CrmMaster',
    moduleName: 'CrmMaster',
    children: [
      { title: 'User',        icon: List,       path: '/allmember',   pageName: 'Crm User Master' },
      { title: 'Department',  icon: CirclePlus, path: '/department',  pageName: 'Crm Department' },
      { title: 'Event Type',  icon: Tag,        path: '/eventtype',   pageName: 'Crm Event Type' },
    ],
  },
...
export const MENU_SIDEBAR_COMPACT = [
  ...
  children: [
    { title: 'Sign In', path: '/auth/signin' },
    { title: 'Login with OTP', path: '/auth/login-otp' },
    { title: 'Sign Up', path: '/auth/signup' },
    { title: '2FA', path: '/auth/2fa' },
    { title: 'Check Email', path: '/auth/check-email' },
    {
      title: 'Reset Password',
      children: [
        { title: 'Enter Email', path: '/auth/request-reset' },
        { title: 'Check Email', path: '/auth/reset-password/check-email' },
        { title: 'Password Changed', path: '/auth/reset-password/changed' },
      ],
    },
  ],
},
