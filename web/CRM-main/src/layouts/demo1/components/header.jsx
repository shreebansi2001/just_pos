...
export function Header() {
  ...
  const userName = 'John'; // You can change this to any name
const { user } = useAuth();
const headerAvatar = user?.userDetails?.logo || user?.pic || toAbsoluteUrl('/media/icon/CRMLOGO1.png');
  ...
  trigger={
    <img
      className="size-9 rounded-full border-2 shrink-0 cursor-pointer object-cover"
      src={headerAvatar}
      alt="User Avatar"
    />
  }
