...
import ProjectDashboard from '../pages/Projectscreen';
...
import LeadReports from '../pages/Leads/Leadreport';
import UserManagement from '../pages/usermanagment/index';
import AllMember from '../pages/Member';
import RoleMaster from '../pages/department';
import EventType from '../pages/EventType';
import NoAccess from '../pages/auth/NoAccess';
import UserProfile from '../pages/account/home/user-profile/account-basic-page';
import AccountUserProfilePage from '../pages/account/home/user-profile/account-basic-page';
import { SsoHandler } from '../pages/auth/SsoHandler';
    ...
    <Routes>
      <Route element={<RequireAuth />}>
        ...
        <Route path='/no-access' element={<NoAccess/>}/>
          ...
          <Route path="/leads/status" element={<LeadStatuses/>}/>
          <Route path="/leads/source" element={<LeadSources/>}/>
          <Route path="/leads/report" element={<LeadReports/>}/>
          <Route path='/usermangement' element={<UserManagement/>}/>
          <Route path="/allmember" element={<AllMember/>}/>
          <Route path="/department" element={<RoleMaster/>}/>
