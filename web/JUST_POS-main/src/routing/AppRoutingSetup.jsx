...
import CategoryList from "../pages/Master/CategoryMaster/CategoryList";
import ItemList from "../pages/Master/ItemMaster/ItemListing";
import FloorListing from "../pages/Master/FloorMaster/FloorListing";
import TableListing from "../pages/Master/TableMaster/TableListing";
import FloorPlanTableView from "../pages/Resturant/BookingView/Floorplantableview";
import CustomersListing from "../pages/Resturant/BookingView/Customerlisting";
import ReservationKanbanBoard from "../pages/Resturant/BookingView/ReservationKanbanBoard";
import OrderTakingPage from "../pages/Resturant/OrderTakingPage";
import KOTDashboard from "../pages/KOT/KotView";
import KotHistory from "../pages/KOT/KotView/KotHistory";
import LiveOrdersSummary from "../pages/Resturant/Live Orders/LiveOrdersSummary";
import AllOrdersPage from "../pages/Resturant/AllOrdersPage";
    ...
    <Routes>
      {/* <Route element={<RequireAuth />}> */}
        ...
        <Route element={<Demo1Layout />}>
          {/* project routs */}
          <Route path="/restaurant/all-orders" element={<AllOrdersPage/>}/>
          <Route path="/order" element={<Navigate to="/order/live-order" replace />} />
          <Route path="/order/live-order" element={<LiveOrdersSummary/>}/>
          <Route path="/order-tracking" element={<LiveOrdersSummary/>}/>
          <Route path="/kot-history" element={<KotHistory/>}/>
          <Route path="/kotview" element={<KOTDashboard/>}/>
          <Route path="/order-booking" element={<FloorPlanTableView/>}/>
          <Route path="/ordertaking" element={<OrderTakingPage/>}/>
          
          <Route path="/master/itemmaster" element={<ItemList/>}/>
          <Route path="/master/categorymaster" element={<CategoryList/>}/>
          <Route path="/master/floormaster" element={<FloorListing/>}/>
          <Route path="/master/tablemaster" element={<TableListing />} />


          <Route path="/customers/list" element={<CustomersListing/>} />
          <Route path="/customers/manage" element={<ReservationKanbanBoard/>} />
