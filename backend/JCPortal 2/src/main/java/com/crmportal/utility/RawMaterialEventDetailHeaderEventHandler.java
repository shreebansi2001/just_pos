...
public class RawMaterialEventDetailHeaderEventHandler extends AbstractPdfDocumentEventHandler {

	private Table headerTable;
	private float topMargin;
	
    public RawMaterialEventDetailHeaderEventHandler(Table table, float topMargin) {
