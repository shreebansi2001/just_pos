...
public class MenuItemRawMaterialHeaderEventHandler extends AbstractPdfDocumentEventHandler {

	private Table headerTable;
	private float topMargin;
	
    public MenuItemRawMaterialHeaderEventHandler(Table table, float topMargin) {
    	this.headerTable = table;
    	this.topMargin = topMargin;
    }
    
    public void updateHeader(Table newHeaderTable) {
    ...
    protected void onAcceptedEvent(AbstractPdfDocumentEvent event) {
        ...
        renderer.setParent(new Document(docEvent.getDocument()).getRenderer());
