...
public class RawMaterialHeaderEventHandlerNew  extends AbstractPdfDocumentEventHandler {

	private Table headerTable;
	private float topMargin;
	
    public RawMaterialHeaderEventHandlerNew(Table table, float topMargin) {
