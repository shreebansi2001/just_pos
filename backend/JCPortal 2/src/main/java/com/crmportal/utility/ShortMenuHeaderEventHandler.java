...
public class ShortMenuHeaderEventHandler extends AbstractPdfDocumentEventHandler {
	
	private final Table headerTable;
	private final float topMargin;
	
    public ShortMenuHeaderEventHandler(Table table, float topMargin) {
	...
	protected void onAcceptedEvent(AbstractPdfDocumentEvent event) {
         ...
         headerTable.setFixedPosition(
                 ...
                 28,  // left margin
                 topPosition,
                 width - 56  // width (page width - margins)
         );
