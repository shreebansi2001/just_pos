...
@Entity
@Table(name = "menupreparationdetails")
@Data
public class MenuPreparationDetailsEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "menu_preparation_details_id")
	private Long id;
	...
	@Column(name = "menuitem_name_hindi")
	private String menuItemNameHindi;

	@Column(name = "menuitem_name_gujarati")
	private String menuItemNameGujarati;

	@Column(name = "menu_category_name")
	private String menuCategoryName;

	@Column(name = "menu_category_name_hindi")
	private String menuCategoryNameHindi;

	@Column(name = "menu_category_name_gujarati")
	...
	@Column(name = "menu_notes")
	private String menuNotes;

	@Column(name = "menu_notes_hindi", columnDefinition = "VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci")
	private String menuNotesHindi;

	@Column(name = "menu_notes_gujarati", columnDefinition = "VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci")
	private String menuNotesGujarati;

	@Column(name = "item_slogan")
	private String itemSlogan;

	@Column(name = "menu_slogan")
